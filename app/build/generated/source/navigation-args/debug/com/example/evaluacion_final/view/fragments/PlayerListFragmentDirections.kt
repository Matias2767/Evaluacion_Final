...
public class PlayerListFragmentDirections private constructor() {
  private data class ActionPlayerListFragmentToPlayerDetailFragment(
    public val player: NbaPlayer
  ) : NavDirections {
    public override val actionId: Int = R.id.action_playerListFragment_to_playerDetailFragment
  ...
  public companion object {
    public fun actionPlayerListFragmentToPlayerDetailFragment(player: NbaPlayer): NavDirections =
        ActionPlayerListFragmentToPlayerDetailFragment(player)
  }
}
